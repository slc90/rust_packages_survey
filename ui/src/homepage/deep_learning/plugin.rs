...
use crate::homepage::{
	...
	deep_learning::systems::{
		...
		handle_whisper_model_cycle_click, handle_whisper_open_file_click,
		handle_whisper_start_click, handle_whisper_timestamp_toggle_click, on_enter, on_exit,
		sync_result_messages, sync_status_messages, update_pending_tasks,
	},
};
			...
			.add_systems(
				...
				(
					(
						...
						handle_whisper_model_cycle_click,
