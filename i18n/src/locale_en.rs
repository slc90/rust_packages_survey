...
pub fn lookup(language_key: LanguageKey) -> &'static str {
	match language_key {
		...
		LanguageKey::RealtimePlot => "Realtime Plot",
		LanguageKey::PlaybackPlot => "Playback Plot",
		LanguageKey::MedicalImage => "Medical Image",
		LanguageKey::VideoPlayer => "Video Player",
